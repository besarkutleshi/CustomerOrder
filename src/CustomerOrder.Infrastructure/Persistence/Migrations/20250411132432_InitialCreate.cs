    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItems", x => new { x.OrderId, x.OrderCustomerId, x.Id });
                    table.ForeignKey(
                        name: "FK_OrderItems_Orders_OrderId_OrderCustomerId",
                        columns: x => new { x.OrderId, x.OrderCustomerId },
